...
jQuery(document).ready(function() {
	"use strict";
		...
		var _sw = '<!-- STYLESWITCHER - REMOVE ON PRODUCTION/DEVELOPMENT -->'
				...
				+ '			<div class="clearfix">'
				+ '				<label><input class="dark_switch" type="radio" name="color_skin" id="is_light" value="light" checked="checked" /> تم سفید</label>'
				+ '				<label><input class="dark_switch" type="radio" name="color_skin" id="is_dark" value="dark" /> تم مشکی <!--<small class="fsize11 styleColor">(BETA)</small>--></label>'
				+ '			</div>'

				+ '			<hr class="hidden-xs" />'

				+ '			<div class="clearfix hidden-xs">'
				+ '				<label><input class="boxed_switch" type="radio" name="layout_style" id="is_wide" value="wide" checked="checked" /> عریض</label>'
				+ '				<label><input class="boxed_switch" type="radio" name="layout_style" id="is_boxed" value="boxed" /> جعبه ای</label>'
				+ '			</div>'

				+ '			<hr />'

				+ '			<div class="clearfix">'
				+ '				<label><input class="rtl_switch" type="radio" name="layout_rtl" id="is_ltr" value="ltr" checked="checked" /> چپ چین</label>'
				+ '				<label><input class="rtl_switch" type="radio" name="layout_rtl" id="is_rtl" value="rtl" /> راست چین</label>'
				+ '			</div>'

				+ '		</div>'

				+ '		<p class="nomargin-bottom">پس زمینه رنگی قالب</p>'
				+ '		<div>'
				...
				+ '		<p class="nomargin-bottom">پس زمینه عکس دار قالب</p>'
				...
				+ '			<button onclick="resetSwitcher();" class="btn btn-primary btn-sm">بازگردانی تنظیمات</button>'
				+ '		</div>'
