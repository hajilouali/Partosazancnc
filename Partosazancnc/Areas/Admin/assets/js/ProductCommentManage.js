$(function () {
    $.get("/Admin/Products/PostCommentResult",
        function (result) {
...
function pageid(id) {
    ...
    $.get("/Admin/Products/PostCommentResult?pageId="  + id,
        function (result) {
            $("#Comment_content").html(result);
        });
...
function Edit(id) {
    $.get("/Admin/Products/CommentEdite/" + id,
        function (result) {
...
function PublishComment(id) {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get('/Admin/Products/PublishComment/' + id,
                    function () {
...
function DraftComment(id) {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get('/Admin/Products/DraftComment/' + id,
                    function () {
...
function DeleteComment(id) {
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.get('/Admin/Products/DeleteComment/' + id,
                    function () {
                        $("#item_" + id).hide('slow');
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $(chkArray).each(function () {
                        $.get('/Admin/Products/PublishComment/' + this,
                            function () {
    ...
    if (chkArray.length > 0) {
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $(chkArray).each(function () {
                        $.get('/Admin/Products/DraftComment/' + this,
                            function () {
    ...
    if (chkArray.length > 0) {
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $(chkArray).each(function () {
                        $.get('/Admin/Products/DeleteComment/' + this,
                            function () {
